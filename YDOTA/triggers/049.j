...
// Trigger: 未命名触发器 049
//===========================================================================
function Trig_049_Conditions takes nothing returns boolean
...
function Trig_049_Func008C takes nothing returns boolean
...
function Trig_049_Func009C takes nothing returns boolean
...
function Trig_049_Func010C takes nothing returns boolean
...
function Trig_049_Func011C takes nothing returns boolean
...
function Trig_049_Func012C takes nothing returns boolean
...
function Trig_049_Func013C takes nothing returns boolean
...
function Trig_049_Func014C takes nothing returns boolean
...
function Trig_049_Func015C takes nothing returns boolean
...
function Trig_049_Func016C takes nothing returns boolean
...
function Trig_049_Func017C takes nothing returns boolean
...
function Trig_049_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'E001', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_049 takes nothing returns nothing
    set gg_trg_049 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_049, gg_unit_n00D_0051, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_049, Condition( function Trig_049_Conditions ) )
    call TriggerAddAction( gg_trg_049, function Trig_049_Actions )
endfunction
