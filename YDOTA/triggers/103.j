...
// Trigger: 未命名触发器 103
//===========================================================================
function Trig_103_Conditions takes nothing returns boolean
...
function Trig_103_Func008C takes nothing returns boolean
...
function Trig_103_Func009C takes nothing returns boolean
...
function Trig_103_Func010C takes nothing returns boolean
...
function Trig_103_Func011C takes nothing returns boolean
...
function Trig_103_Func012C takes nothing returns boolean
...
function Trig_103_Func013C takes nothing returns boolean
...
function Trig_103_Func014C takes nothing returns boolean
...
function Trig_103_Func015C takes nothing returns boolean
...
function Trig_103_Func016C takes nothing returns boolean
...
function Trig_103_Func017C takes nothing returns boolean
...
function Trig_103_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'N00T', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_103 takes nothing returns nothing
    set gg_trg_103 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_103, gg_unit_n00F_0028, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_103, Condition( function Trig_103_Conditions ) )
    call TriggerAddAction( gg_trg_103, function Trig_103_Actions )
endfunction
