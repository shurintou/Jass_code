...
// Trigger: 未命名触发器 058
//===========================================================================
function Trig_058_Conditions takes nothing returns boolean
...
function Trig_058_Func008C takes nothing returns boolean
...
function Trig_058_Func009C takes nothing returns boolean
...
function Trig_058_Func010C takes nothing returns boolean
...
function Trig_058_Func011C takes nothing returns boolean
...
function Trig_058_Func012C takes nothing returns boolean
...
function Trig_058_Func013C takes nothing returns boolean
...
function Trig_058_Func014C takes nothing returns boolean
...
function Trig_058_Func015C takes nothing returns boolean
...
function Trig_058_Func016C takes nothing returns boolean
...
function Trig_058_Func017C takes nothing returns boolean
...
function Trig_058_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'N00A', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_058 takes nothing returns nothing
    set gg_trg_058 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_058, gg_unit_n00F_0028, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_058, Condition( function Trig_058_Conditions ) )
    call TriggerAddAction( gg_trg_058, function Trig_058_Actions )
endfunction
