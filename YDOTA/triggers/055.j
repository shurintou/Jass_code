...
// Trigger: 未命名触发器 055
//===========================================================================
function Trig_055_Conditions takes nothing returns boolean
...
function Trig_055_Func008C takes nothing returns boolean
...
function Trig_055_Func009C takes nothing returns boolean
...
function Trig_055_Func010C takes nothing returns boolean
...
function Trig_055_Func011C takes nothing returns boolean
...
function Trig_055_Func012C takes nothing returns boolean
...
function Trig_055_Func013C takes nothing returns boolean
...
function Trig_055_Func014C takes nothing returns boolean
...
function Trig_055_Func015C takes nothing returns boolean
...
function Trig_055_Func016C takes nothing returns boolean
...
function Trig_055_Func017C takes nothing returns boolean
...
function Trig_055_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'E000', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_055 takes nothing returns nothing
    set gg_trg_055 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_055, gg_unit_n00F_0028, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_055, Condition( function Trig_055_Conditions ) )
    call TriggerAddAction( gg_trg_055, function Trig_055_Actions )
endfunction
