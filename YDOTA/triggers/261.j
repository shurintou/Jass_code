...
// Trigger: 未命名触发器 261
//===========================================================================
function Trig_261_Conditions takes nothing returns boolean
...
function Trig_261_Func003C takes nothing returns boolean
...
function Trig_261_Func004C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_261_Func005C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_261_Func006C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_261_Func007C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_261_Actions takes nothing returns nothing
    call EnableTrigger( gg_trg_260 )
    call AdjustPlayerStateBJ( 1, GetOwningPlayer(GetKillingUnitBJ()), PLAYER_STATE_RESOURCE_LUMBER )
    if ( Trig_261_Func003C() ) then
...
//===========================================================================
function InitTrig_261 takes nothing returns nothing
    set gg_trg_261 = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_261, EVENT_PLAYER_UNIT_DEATH )
    call TriggerAddCondition( gg_trg_261, Condition( function Trig_261_Conditions ) )
    call TriggerAddAction( gg_trg_261, function Trig_261_Actions )
endfunction
