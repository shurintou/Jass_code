...
// Trigger: 未命名触发器 044
//===========================================================================
function Trig_044_Conditions takes nothing returns boolean
...
function Trig_044_Func008C takes nothing returns boolean
...
function Trig_044_Func009C takes nothing returns boolean
...
function Trig_044_Func010C takes nothing returns boolean
...
function Trig_044_Func011C takes nothing returns boolean
...
function Trig_044_Func012C takes nothing returns boolean
...
function Trig_044_Func013C takes nothing returns boolean
...
function Trig_044_Func014C takes nothing returns boolean
...
function Trig_044_Func015C takes nothing returns boolean
...
function Trig_044_Func016C takes nothing returns boolean
...
function Trig_044_Func017C takes nothing returns boolean
...
function Trig_044_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'H001', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_044 takes nothing returns nothing
    set gg_trg_044 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_044, gg_unit_n00D_0051, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_044, Condition( function Trig_044_Conditions ) )
    call TriggerAddAction( gg_trg_044, function Trig_044_Actions )
endfunction
