...
// Trigger: 未命名触发器 268
//===========================================================================
function Trig_268_Conditions takes nothing returns boolean
...
function Trig_268_Func007C takes nothing returns boolean
...
function Trig_268_Func008C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_268_Func009C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_268_Func010C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_268_Func011C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_268_Actions takes nothing returns nothing
    call EnableTrigger( gg_trg_282 )
    call AdjustPlayerStateBJ( 1, GetOwningPlayer(GetKillingUnitBJ()), PLAYER_STATE_RESOURCE_LUMBER )
    if ( Trig_268_Func007C() ) then
...
//===========================================================================
function InitTrig_268 takes nothing returns nothing
    set gg_trg_268 = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_268, EVENT_PLAYER_UNIT_DEATH )
    call TriggerAddCondition( gg_trg_268, Condition( function Trig_268_Conditions ) )
    call TriggerAddAction( gg_trg_268, function Trig_268_Actions )
endfunction
