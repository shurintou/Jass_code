...
// Trigger: 未命名触发器 051
//===========================================================================
function Trig_051_Conditions takes nothing returns boolean
...
function Trig_051_Func008C takes nothing returns boolean
...
function Trig_051_Func009C takes nothing returns boolean
...
function Trig_051_Func010C takes nothing returns boolean
...
function Trig_051_Func011C takes nothing returns boolean
...
function Trig_051_Func012C takes nothing returns boolean
...
function Trig_051_Func013C takes nothing returns boolean
...
function Trig_051_Func014C takes nothing returns boolean
...
function Trig_051_Func015C takes nothing returns boolean
...
function Trig_051_Func016C takes nothing returns boolean
...
function Trig_051_Func017C takes nothing returns boolean
...
function Trig_051_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'H005', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_051 takes nothing returns nothing
    set gg_trg_051 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_051, gg_unit_n00F_0028, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_051, Condition( function Trig_051_Conditions ) )
    call TriggerAddAction( gg_trg_051, function Trig_051_Actions )
endfunction
