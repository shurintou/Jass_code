...
// Trigger: 未命名触发器 050
//===========================================================================
function Trig_050_Conditions takes nothing returns boolean
...
function Trig_050_Func008C takes nothing returns boolean
...
function Trig_050_Func009C takes nothing returns boolean
...
function Trig_050_Func010C takes nothing returns boolean
...
function Trig_050_Func011C takes nothing returns boolean
...
function Trig_050_Func012C takes nothing returns boolean
...
function Trig_050_Func013C takes nothing returns boolean
...
function Trig_050_Func014C takes nothing returns boolean
...
function Trig_050_Func015C takes nothing returns boolean
...
function Trig_050_Func016C takes nothing returns boolean
...
function Trig_050_Func017C takes nothing returns boolean
...
function Trig_050_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'N00C', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_050 takes nothing returns nothing
    set gg_trg_050 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_050, gg_unit_n00D_0051, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_050, Condition( function Trig_050_Conditions ) )
    call TriggerAddAction( gg_trg_050, function Trig_050_Actions )
endfunction
