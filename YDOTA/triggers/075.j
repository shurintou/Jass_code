...
// Trigger: 未命名触发器 075
//===========================================================================
function Trig_075_Conditions takes nothing returns boolean
...
function Trig_075_Func008C takes nothing returns boolean
...
function Trig_075_Func009C takes nothing returns boolean
...
function Trig_075_Func010C takes nothing returns boolean
...
function Trig_075_Func011C takes nothing returns boolean
...
function Trig_075_Func012C takes nothing returns boolean
...
function Trig_075_Func013C takes nothing returns boolean
...
function Trig_075_Func014C takes nothing returns boolean
...
function Trig_075_Func015C takes nothing returns boolean
...
function Trig_075_Func016C takes nothing returns boolean
...
function Trig_075_Func017C takes nothing returns boolean
...
function Trig_075_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'N00K', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_075 takes nothing returns nothing
    set gg_trg_075 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_075, gg_unit_n000_0029, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_075, Condition( function Trig_075_Conditions ) )
    call TriggerAddAction( gg_trg_075, function Trig_075_Actions )
endfunction
