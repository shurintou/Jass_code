...
// Trigger: 未命名触发器 267
//===========================================================================
function Trig_267_Conditions takes nothing returns boolean
...
function Trig_267_Func007C takes nothing returns boolean
...
function Trig_267_Func008C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_267_Func009C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_267_Func010C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_267_Func011C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_267_Actions takes nothing returns nothing
    call EnableTrigger( gg_trg_280 )
    call AdjustPlayerStateBJ( 1, GetOwningPlayer(GetKillingUnitBJ()), PLAYER_STATE_RESOURCE_LUMBER )
    if ( Trig_267_Func007C() ) then
...
//===========================================================================
function InitTrig_267 takes nothing returns nothing
    set gg_trg_267 = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_267, EVENT_PLAYER_UNIT_DEATH )
    call TriggerAddCondition( gg_trg_267, Condition( function Trig_267_Conditions ) )
    call TriggerAddAction( gg_trg_267, function Trig_267_Actions )
endfunction
