...
// Trigger: 未命名触发器 054
//===========================================================================
function Trig_054_Conditions takes nothing returns boolean
...
function Trig_054_Func008C takes nothing returns boolean
...
function Trig_054_Func009C takes nothing returns boolean
...
function Trig_054_Func010C takes nothing returns boolean
...
function Trig_054_Func011C takes nothing returns boolean
...
function Trig_054_Func012C takes nothing returns boolean
...
function Trig_054_Func013C takes nothing returns boolean
...
function Trig_054_Func014C takes nothing returns boolean
...
function Trig_054_Func015C takes nothing returns boolean
...
function Trig_054_Func016C takes nothing returns boolean
...
function Trig_054_Func017C takes nothing returns boolean
...
function Trig_054_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'H004', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_054 takes nothing returns nothing
    set gg_trg_054 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_054, gg_unit_n00F_0028, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_054, Condition( function Trig_054_Conditions ) )
    call TriggerAddAction( gg_trg_054, function Trig_054_Actions )
endfunction
