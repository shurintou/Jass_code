...
// Trigger: 未命名触发器 265
//===========================================================================
function Trig_265_Conditions takes nothing returns boolean
...
function Trig_265_Func007C takes nothing returns boolean
...
function Trig_265_Func008C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_265_Func009C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_265_Func010C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_265_Func011C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_265_Actions takes nothing returns nothing
    call EnableTrigger( gg_trg_276 )
    call AdjustPlayerStateBJ( 1, GetOwningPlayer(GetKillingUnitBJ()), PLAYER_STATE_RESOURCE_LUMBER )
    if ( Trig_265_Func007C() ) then
...
//===========================================================================
function InitTrig_265 takes nothing returns nothing
    set gg_trg_265 = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_265, EVENT_PLAYER_UNIT_DEATH )
    call TriggerAddCondition( gg_trg_265, Condition( function Trig_265_Conditions ) )
    call TriggerAddAction( gg_trg_265, function Trig_265_Actions )
endfunction
