...
// Trigger: 未命名触发器 117
//===========================================================================
function Trig_117_Conditions takes nothing returns boolean
...
function Trig_117_Func008C takes nothing returns boolean
...
function Trig_117_Func009C takes nothing returns boolean
...
function Trig_117_Func010C takes nothing returns boolean
...
function Trig_117_Func011C takes nothing returns boolean
...
function Trig_117_Func012C takes nothing returns boolean
...
function Trig_117_Func013C takes nothing returns boolean
...
function Trig_117_Func014C takes nothing returns boolean
...
function Trig_117_Func015C takes nothing returns boolean
...
function Trig_117_Func016C takes nothing returns boolean
...
function Trig_117_Func017C takes nothing returns boolean
...
function Trig_117_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'O00E', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_117 takes nothing returns nothing
    set gg_trg_117 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_117, gg_unit_n010_0035, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_117, Condition( function Trig_117_Conditions ) )
    call TriggerAddAction( gg_trg_117, function Trig_117_Actions )
endfunction
