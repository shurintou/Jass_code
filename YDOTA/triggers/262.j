...
// Trigger: 未命名触发器 262
//===========================================================================
function Trig_262_Conditions takes nothing returns boolean
...
function Trig_262_Func007C takes nothing returns boolean
...
function Trig_262_Func008C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_262_Func009C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_262_Func010C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_262_Func011C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_262_Actions takes nothing returns nothing
    call EnableTrigger( gg_trg_270 )
    call AdjustPlayerStateBJ( 1, GetOwningPlayer(GetKillingUnitBJ()), PLAYER_STATE_RESOURCE_LUMBER )
    if ( Trig_262_Func007C() ) then
...
//===========================================================================
function InitTrig_262 takes nothing returns nothing
    set gg_trg_262 = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_262, EVENT_PLAYER_UNIT_DEATH )
    call TriggerAddCondition( gg_trg_262, Condition( function Trig_262_Conditions ) )
    call TriggerAddAction( gg_trg_262, function Trig_262_Actions )
endfunction
