...
// Trigger: 未命名触发器 263
//===========================================================================
function Trig_263_Conditions takes nothing returns boolean
...
function Trig_263_Func007C takes nothing returns boolean
...
function Trig_263_Func008C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_263_Func009C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_263_Func010C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_263_Func011C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_263_Actions takes nothing returns nothing
    call EnableTrigger( gg_trg_272 )
    call AdjustPlayerStateBJ( 1, GetOwningPlayer(GetKillingUnitBJ()), PLAYER_STATE_RESOURCE_LUMBER )
    if ( Trig_263_Func007C() ) then
...
//===========================================================================
function InitTrig_263 takes nothing returns nothing
    set gg_trg_263 = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_263, EVENT_PLAYER_UNIT_DEATH )
    call TriggerAddCondition( gg_trg_263, Condition( function Trig_263_Conditions ) )
    call TriggerAddAction( gg_trg_263, function Trig_263_Actions )
endfunction
