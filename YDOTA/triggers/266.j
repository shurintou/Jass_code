...
// Trigger: 未命名触发器 266
//===========================================================================
function Trig_266_Conditions takes nothing returns boolean
...
function Trig_266_Func007C takes nothing returns boolean
...
function Trig_266_Func008C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_266_Func009C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_266_Func010C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_266_Func011C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_266_Actions takes nothing returns nothing
    call EnableTrigger( gg_trg_278 )
    call AdjustPlayerStateBJ( 1, GetOwningPlayer(GetKillingUnitBJ()), PLAYER_STATE_RESOURCE_LUMBER )
    if ( Trig_266_Func007C() ) then
...
//===========================================================================
function InitTrig_266 takes nothing returns nothing
    set gg_trg_266 = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_266, EVENT_PLAYER_UNIT_DEATH )
    call TriggerAddCondition( gg_trg_266, Condition( function Trig_266_Conditions ) )
    call TriggerAddAction( gg_trg_266, function Trig_266_Actions )
endfunction
