...
// Trigger: 未命名触发器 048
//===========================================================================
function Trig_048_Conditions takes nothing returns boolean
...
function Trig_048_Func008C takes nothing returns boolean
...
function Trig_048_Func009C takes nothing returns boolean
...
function Trig_048_Func010C takes nothing returns boolean
...
function Trig_048_Func011C takes nothing returns boolean
...
function Trig_048_Func012C takes nothing returns boolean
...
function Trig_048_Func013C takes nothing returns boolean
...
function Trig_048_Func014C takes nothing returns boolean
...
function Trig_048_Func015C takes nothing returns boolean
...
function Trig_048_Func016C takes nothing returns boolean
...
function Trig_048_Func017C takes nothing returns boolean
...
function Trig_048_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'H003', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_048 takes nothing returns nothing
    set gg_trg_048 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_048, gg_unit_n00D_0051, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_048, Condition( function Trig_048_Conditions ) )
    call TriggerAddAction( gg_trg_048, function Trig_048_Actions )
endfunction
