...
// Trigger: 未命名触发器 045
//===========================================================================
function Trig_045_Conditions takes nothing returns boolean
...
function Trig_045_Func008C takes nothing returns boolean
...
function Trig_045_Func009C takes nothing returns boolean
...
function Trig_045_Func010C takes nothing returns boolean
...
function Trig_045_Func011C takes nothing returns boolean
...
function Trig_045_Func012C takes nothing returns boolean
...
function Trig_045_Func013C takes nothing returns boolean
...
function Trig_045_Func014C takes nothing returns boolean
...
function Trig_045_Func015C takes nothing returns boolean
...
function Trig_045_Func016C takes nothing returns boolean
...
function Trig_045_Func017C takes nothing returns boolean
...
function Trig_045_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'N00E', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_045 takes nothing returns nothing
    set gg_trg_045 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_045, gg_unit_n00D_0051, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_045, Condition( function Trig_045_Conditions ) )
    call TriggerAddAction( gg_trg_045, function Trig_045_Actions )
endfunction
