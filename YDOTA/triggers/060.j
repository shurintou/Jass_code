...
// Trigger: 未命名触发器 060
//===========================================================================
function Trig_060_Conditions takes nothing returns boolean
...
function Trig_060_Func008C takes nothing returns boolean
...
function Trig_060_Func009C takes nothing returns boolean
...
function Trig_060_Func010C takes nothing returns boolean
...
function Trig_060_Func011C takes nothing returns boolean
...
function Trig_060_Func012C takes nothing returns boolean
...
function Trig_060_Func013C takes nothing returns boolean
...
function Trig_060_Func014C takes nothing returns boolean
...
function Trig_060_Func015C takes nothing returns boolean
...
function Trig_060_Func016C takes nothing returns boolean
...
function Trig_060_Func017C takes nothing returns boolean
...
function Trig_060_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'N001', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_060 takes nothing returns nothing
    set gg_trg_060 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_060, gg_unit_n000_0029, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_060, Condition( function Trig_060_Conditions ) )
    call TriggerAddAction( gg_trg_060, function Trig_060_Actions )
endfunction
