...
// Trigger: right
//===========================================================================
function rightdistanceofhero takes nothing returns nothing
...
function Trig_right_Conditions takes nothing returns boolean
    if udg_CameraUnit!=null then
        ...
        set udg_Re=99999
        call ForGroup(udg_HeroGroup, function rightdistanceofhero)
...
function InitTrig_right takes nothing returns nothing
    ...
    call TriggerRegisterPlayerEvent( gg_trg_right, Player(0), EVENT_PLAYER_ARROW_RIGHT_DOWN)
