...
// Trigger: 未命名触发器 251
//===========================================================================
function Trig_251_Conditions takes nothing returns boolean
...
function Trig_251_Func004C takes nothing returns boolean
...
function Trig_251_Func005C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_251_Func006C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_251_Func007C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_251_Func008C takes nothing returns boolean
    if ( not ( IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_STRUCTURE) == false ) ) then
        return false
    endif
...
function Trig_251_Actions takes nothing returns nothing
    call EnableTrigger( gg_trg_250 )
    call AdjustPlayerStateBJ( 1, GetOwningPlayer(GetKillingUnitBJ()), PLAYER_STATE_RESOURCE_LUMBER )
    if ( Trig_251_Func004C() ) then
...
//===========================================================================
function InitTrig_251 takes nothing returns nothing
    set gg_trg_251 = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_251, EVENT_PLAYER_UNIT_DEATH )
    call TriggerAddCondition( gg_trg_251, Condition( function Trig_251_Conditions ) )
    call TriggerAddAction( gg_trg_251, function Trig_251_Actions )
endfunction
