...
// Trigger: 未命名触发器 077
//===========================================================================
function Trig_077_Conditions takes nothing returns boolean
...
function Trig_077_Func008C takes nothing returns boolean
...
function Trig_077_Func009C takes nothing returns boolean
...
function Trig_077_Func010C takes nothing returns boolean
...
function Trig_077_Func011C takes nothing returns boolean
...
function Trig_077_Func012C takes nothing returns boolean
...
function Trig_077_Func013C takes nothing returns boolean
...
function Trig_077_Func014C takes nothing returns boolean
...
function Trig_077_Func015C takes nothing returns boolean
...
function Trig_077_Func016C takes nothing returns boolean
...
function Trig_077_Func017C takes nothing returns boolean
...
function Trig_077_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'H008', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_077 takes nothing returns nothing
    set gg_trg_077 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_077, gg_unit_n000_0029, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_077, Condition( function Trig_077_Conditions ) )
    call TriggerAddAction( gg_trg_077, function Trig_077_Actions )
endfunction
