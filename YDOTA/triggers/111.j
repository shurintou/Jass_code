...
// Trigger: 未命名触发器 111
//===========================================================================
function Trig_111_Conditions takes nothing returns boolean
...
function Trig_111_Func008C takes nothing returns boolean
...
function Trig_111_Func009C takes nothing returns boolean
...
function Trig_111_Func010C takes nothing returns boolean
...
function Trig_111_Func011C takes nothing returns boolean
...
function Trig_111_Func012C takes nothing returns boolean
...
function Trig_111_Func013C takes nothing returns boolean
...
function Trig_111_Func014C takes nothing returns boolean
...
function Trig_111_Func015C takes nothing returns boolean
...
function Trig_111_Func016C takes nothing returns boolean
...
function Trig_111_Func017C takes nothing returns boolean
...
function Trig_111_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetBuyingUnit(), 'U001', bj_UNIT_STATE_METHOD_DEFAULTS )
...
//===========================================================================
function InitTrig_111 takes nothing returns nothing
    set gg_trg_111 = CreateTrigger(  )
    call TriggerRegisterUnitEvent( gg_trg_111, gg_unit_n000_0029, EVENT_UNIT_SELL_ITEM )
    call TriggerAddCondition( gg_trg_111, Condition( function Trig_111_Conditions ) )
    call TriggerAddAction( gg_trg_111, function Trig_111_Actions )
endfunction
